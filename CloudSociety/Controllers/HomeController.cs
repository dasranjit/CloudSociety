...
namespace CloudSociety.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult MemberUpcoming(Guid id,String module)
        {
            ...
            ViewBag.SocietySubscriptionID = id;
            ViewBag.Module = module;
            var ss = societySubscriptionService.GetById(id);
            ViewBag.ShowFinalReports = ss.Closed;
            ViewBag.ShowCommunication = new SocietyMemberService(this.ModelState).IsCommunicationEnabled(ss.SocietyID);
