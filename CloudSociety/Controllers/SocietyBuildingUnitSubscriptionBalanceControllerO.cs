...
namespace CloudSociety.Controllers
{
    ...
    public class SocietyBuildingUnitSubscriptionBalanceController : Controller
    {
        ...
        public ActionResult Index1(Guid id)
        {
            ...
            ViewBag.AllowToDelete = societySubscriptionService.ListByParentId(societySubscription.SocietyID).Where(s => s.SubscriptionStart > societySubscription.SubscriptionStart).Count() > 0 ? true : false;
        ...
        public ActionResult Index2(Guid societyBuildingUnitID, Guid societySubscriptionID)
        {
            ...
            //ViewBag.AllowToDelete = ((List<SocietyBill>)new SocietyBillService(this.ModelState).ListBySocietyBuildingUnitID(societyBuildingUnitID)).Count > 0 ? true : false;
            bool IsAnyReceipt = new SocietyReceiptService(this.ModelState).ListByParentId(societyBuildingUnit.SocietyBuilding.SocietyID).Count() > 0;
            bool IsAnyBill = new SocietyBillService(this.ModelState).ListBySocietyBuildingUnitID(societyBuildingUnitID).Count() > 0;
            IEnumerable<SocietyBuildingUnitSubscriptionBalance> SocietyBuildingUnitSubscriptionBalanceList = _service.ListBySocietyBuildingUnitID(societyBuildingUnitID);
            ViewBag.IsReadOnly = (IsAnyBill || IsAnyReceipt);
            return View(SocietyBuildingUnitSubscriptionBalanceList);
        }
        [HttpGet]
        ...
        public ActionResult Create2(Guid societyBuildingUnitID, Guid societySubscriptionID) // id = SocietySubscriptionID
        {
            ...
            ViewBag.SocietyMembersList = new SocietyMemberService(this.ModelState).ListBySocietyBuildUnitID(societyBuildingUnitID);//u.Where(m => m.SocietyMemberID != SocietyBuildingUnit.SocietyBuildingUnitTransfers.FirstOrDefault().SocietyMemberID);
            return View();
        }
        ...
        public ActionResult Edit1(Guid id, Guid societySubscriptionID)
        {
            ...
            ViewBag.BillAbbreviationList = new SocietyBillSeriesService(this.ModelState).ListByParentId(societySubscriptionService.GetById(societySubscriptionID).SocietyID);
            ViewBag.SocietyMembersList = new SocietyMemberService(this.ModelState).ListBySocietyBuildUnitID(societyBuildingUnitSubscriptionBalance.SocietyBuildingUnitID);
