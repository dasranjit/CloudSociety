...
{
    public class SocietyMemberTenantService : IGenericChildRepository<SocietyMemberTenant>
    {
        private IGenericChildRepository<SocietyMemberTenant> _cache;
        ...
        public SocietyMemberTenantService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new SocietyMemberTenantCache();
        }
