...
{
    public class SocietyMemberDocumentService : IGenericChildRepository<SocietyMemberDocument>
    {
        private IGenericChildRepository<SocietyMemberDocument> _cache;
        ...
        public SocietyMemberDocumentService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new SocietyMemberDocumentCache();
        }
