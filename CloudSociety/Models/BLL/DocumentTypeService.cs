...
{
    public class DocumentTypeService : IGenericRepository<DocumentType>
    {
        private IGenericRepository<DocumentType> _cache;
        ...
        public DocumentTypeService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new DocumentTypeCache();
        }
