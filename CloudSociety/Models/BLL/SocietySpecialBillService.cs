...
{
    public class SocietySpecialBillService : IGenericChildRepository<SocietySpecialBill>
    {
        private IGenericChildRepository<SocietySpecialBill> _cache;
        ...
        public SocietySpecialBillService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new SocietySpecialBillCache();
        }
