...
{
    public class ParkingTypeService : IGenericRepository<ParkingType>
    {
        private IGenericRepository<ParkingType> _cache;
        ...
        public ParkingTypeService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new ParkingTypeCache();
        }
