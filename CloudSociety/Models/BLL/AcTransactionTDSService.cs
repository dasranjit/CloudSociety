...
{
    public class AcTransactionTDSSetervice : IGenericChildRepository<AcTransactionTDS>
    {
        private IGenericChildRepository<AcTransactionTDS> _cache;
        ...
        public AcTransactionTDSSetervice(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new AcTransactionTDSCache();
        }
