...
{
    public class PasswordQuestionService : IGenericRepository<PasswordQuestion>
    {
        private IGenericRepository<PasswordQuestion> _cache;
        ...
        public PasswordQuestionService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new PasswordQuestionCache();
        }
