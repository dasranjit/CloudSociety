...
{
    public class SocietyBuildingService : IGenericChildRepository<SocietyBuilding>
    {
        private IGenericChildRepository<SocietyBuilding> _cache;
        ...
        public SocietyBuildingService(ModelStateDictionary modelState)
        {
            _modelState = modelState;
            _cache = new SocietyBuildingCache();
        }
